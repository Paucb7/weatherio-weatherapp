...
/**
 *  Alternar busqueda en dispositivos moviles
 */
...
/**
 * RENDERIZAR TODA LA INFORMACION DEL CLIMA EN HTML
 * 
...
export const updateWeather = function (lat,lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function(currentWeather){
        ...
        card.innerHTML = `
            <h2 class="title-2 card-title">Ahora</h2>
            ...
            card.innerHTML = `
                ...
                <div class="highlight-list">
                    ...
                    <div class="card card-sm highlight-card one">
                        ...
                        <h3 class="title-3">Indice de calidad de aire</h3>
        ...
        fetchData(url.forecast(lat, lon), function(forecast) {
             ...
             */
            forecastSection.innerHTML = `
                <h2 class="title-2" id="forecast-label">Pronostico a 5 dias</h2>
